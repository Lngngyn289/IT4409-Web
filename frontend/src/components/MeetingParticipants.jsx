      ...
      <div className="flex-1 overflow-y-auto">
        {allParticipants.length === 0 ? (
          <div className="flex items-center justify-center h-full text-gray-400">
            <p className="text-center text-sm">No participants yet</p>
          </div>
        ) : (
          allParticipants.map((participant, index) => {
            ...
            return (
              <div
                ...
                className="flex items-center gap-3 p-4 border-b border-gray-700 hover:bg-gray-800 transition-colors"
              >
                {/* Avatar */}
